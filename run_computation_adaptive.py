...
RDSParam = [['1.6','13.51','8000','N','SCH','So']]
...
for l in range(0,len(RDSParam)):
    ...
    if RDSParam[l][5] == 'So':
        subprocess.call([sys.executable, 'rds_FENICS_adaptive_CN.py', RDSParam[l][0], RDSParam[l][1], RDSParam[l][2], RDSParam[l][3], RDSParam[l][4],'%d'%k])
