...
if __name__ == '__main__':
    ...
    TOL = 1e-7
    source = 1.0
    parameter_list = [[0.02, 0.17, 0.08, 0.03, 1e-6], [0.12, 0.90, 0.20, 0.02, 1e-5], [0.5, 3.80, 2.80, 0.02, 1e-4], [1.1, 8.20, 6.20, 0.01, 1e-3], [1.6, 12.90, 10.00, 0.01, 1e-3], [4.0, 33.00, 25.00, 0.01, 1e-3]]
